...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/erp/pr/managepr/test/integration/FirstJourney",
    "com/erp/pr/managepr/test/integration/RequisitionsListJourney",
    "com/erp/pr/managepr/test/integration/RequisitionsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
